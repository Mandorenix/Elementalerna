...
import { Element, ElementalBonus } from '../types';
import { ELEMENT_ICONS, elementThemes, ELEMENTAL_AFFINITY_BONUSES } from '../constants';

interface ElementalAffinityTooltipProps {
    element: Element;
    currentPoints: number;
}

const ElementalAffinityTooltip: React.FC<ElementalAffinityTooltipProps> = ({ element, currentPoints }) => {
...
interface ElementalAffinityButtonProps {
    element: Element;
    currentPoints: number;
    canIncrease: boolean;
    onIncrease: (element: Element) => void;
}

const ElementalAffinityButton: React.FC<ElementalAffinityButtonProps> = ({
    element,
    currentPoints,
    canIncrease,
    onIncrease,
...
export default ElementalAffinityButton;